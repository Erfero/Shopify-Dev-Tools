...
export function SettingsForm({ targetGender, language, reviewCount, onChange, hideAutoFilled = false }: SettingsFormProps) {
  ...
  return (
    <div className="animate-fade-up">
      <div className="flex items-start gap-4 mb-8 pb-6" style={{ borderBottom: "1px solid oklch(0.922 0 0)" }}>
        ...
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: "var(--text-secondary)" }}>
            {hideAutoFilled
              ? "Choisissez le nombre d'avis — genre et langue viennent du Customizer"
      ...
      <div className="space-y-7">
        {/* Gender — hidden when auto-filled */}
        {!hideAutoFilled && (
          <div>
        ...
        {/* Language — hidden when auto-filled */}
        {!hideAutoFilled && (
          <div>
            <label className="label">
